...
<div class="woocommerce_variation wc-metabox closed">
	...
	<div class="woocommerce_variable_attributes wc-metabox-content" style="display: none;">
		<div class="data">
			<!-- barcode variations custom hook start -->
				<?php do_action( 'woocommerce_product_begin_variable_attributes', $loop, $variation_data, $variation_id ); ?>
			<!-- barcode variations custom hook end -->
